...
def train(train_dir, df_val, df_train, model, epochs=10):
    ...
    train_generator = train_datagen.flow_from_dataframe(df_train, **generator_args)

    # Validation data generator
    val_datagen = ImageDataGenerator()

    val_generator = val_datagen.flow_from_dataframe(df_val, **generator_args)
    model.fit(
        train_generator,
        epochs=epochs,
...
if __name__ == "__main__":
    ...
    df_train, df_val = train_test_split(labels_df, test_size=0.2, random_state=SEED)
